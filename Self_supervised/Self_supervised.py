...
n1 = 50                # the number of nodes in the first hidden layer (Z1)
n2 = 30                # the number of nodes in the bottleneck hidden layer (Z2)
...
class Autoencoder(nn.Module):
    ...
    def __init__(self, n1, n2):
        ...
        self.fc3 = nn.Linear(n2,n1)
        self.fc4 = nn.Linear(n1,784)
    ...
    def forward(self,x):
        ...
        Y = torch.sigmoid(self.fc4(Z3))
        return Z1, Z2, Z3, Y

model = Autoencoder(n1,n2).to(DEVICE)
...
def main():
    ...
    print('(Regression model(X-Z1-Z2-Z3-Y), Data : {}, Activation : {})'.format(Data, activation))
    ...
    for epoch in range(1, EPOCH + 1):
        ...
        _,_,_, decoded_data = model(test_x)
